...
spark.read.json(
    "gs://airflow-training-knab-asv/land_registry_price_paid_uk/*/*.json"
).withColumn(
...
spark.read.json("gs://airflow-training-knab-asv/currency/*.json").withColumn(
...
(
    ...
    .parquet("gs://airflow-training-knab-asv/average_prices/")
)